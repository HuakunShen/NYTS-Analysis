...
So I pick some of the common columns that are representative, such as race, age, school type, smoked, curious.
**curious** stands for "have been curious in smoking a cigarette".
...
[TODO: How is data collected]

Figure \@ref(fig:dataset-preview) shows a preview of the dataset by displaying the distribution of smoking population (not percentage) by various properties.
...
```{r trend-plot, echo=FALSE, fig.height=2, fig.cap="Trend of Sample Size and Smoker Population"}
